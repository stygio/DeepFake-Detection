...
class Reseption1(nn.Module):

	def __init__(self, num_classes=1, init_weights=True):
		super(Reseption1, self).__init__()
		...
		self.Reseption_A_1 = Reseption_A(192, scale_factor = 1)
		self.Reseption_A_2 = Reseption_A(192, scale_factor = 1)
		self.Reseption_A_3 = Reseption_A(192, scale_factor = 1)
		self.Reduction_A = Reseption_Reduction_A(192)
		self.Reseption_B_1 = Reseption_B(640, scale_factor = 1)
		self.Reseption_B_2 = Reseption_B(640, scale_factor = 1)
		self.Reseption_B_3 = Reseption_B(640, scale_factor = 1)
		self.Reseption_B_4 = Reseption_B(640, scale_factor = 1)
		self.Reduction_B = Reseption_Reduction_B(640)
		self.Reseption_C_1 = Reseption_C(1280, scale_factor = 1)
		self.Reseption_C_2 = Reseption_C(1280, scale_factor = 1)
