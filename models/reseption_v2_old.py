...
class Reseption2(nn.Module):
	...
	def __init__(self, num_classes=1, init_weights=True):
		...
		self.Mixed_5b = Reseption_A(224, scale_factor = 1)
		self.Mixed_5c = Reseption_A(224, scale_factor = 1)
		self.Mixed_5d = Reseption_A(224, scale_factor = 1)
		self.Mixed_6a = Reseption_Reduction_A(224)
		self.Mixed_6b = Reseption_B(784, scale_factor = 1)
		self.Mixed_6c = Reseption_B(784, scale_factor = 1)
		self.Mixed_6d = Reseption_B(784, scale_factor = 1)
		self.Mixed_6e = Reseption_B(784, scale_factor = 1)
		self.Mixed_7a = Reseption_Reduction_B(784)
		self.Mixed_7b = Reseption_C(1568, scale_factor = 1)
		self.Mixed_7c = Reseption_C(1568, scale_factor = 1)
