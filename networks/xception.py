...
"""
Modified for the DeepFake-Detection project
...
def xception(pretrained=False,**kwargs):
    ...
    if pretrained:
        ...
        # Create a state_dict with the pretrained weights for those layers that match the original model
        filtered_dict = {k: v for k, v in pretrained_dict.items() if k in model_dict}
        # Update with those weights
